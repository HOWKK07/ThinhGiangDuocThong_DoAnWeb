...
namespace ThinhGiangDuocThong_DoAnWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //Đảm bảo role User tồn tại trong database
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Luôn gán role User cho người dùng mới đăng ký
